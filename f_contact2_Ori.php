...
if ( ! empty($errors)) {
    ...
    if (!in_array($ext, $allowed)) {
     ...
     $content = "<b>New Inquiry Contact</b><br><p>Name : $name</p><p>Email : $email</p><p>Company : $company</p><p>Industry : $industry</p><p>Message : $message</p><p>Attachment : $file_url</p><span>utm: $from_utm | url: $from_url</span>";
